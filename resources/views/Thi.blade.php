...
@section('content')
    <div class="container">
        ...
        <a href="{{ url('thoat') }}"><img class="close" src="img/AiLaTrieuPhu/close.png" alt=""></a> 
        <div class="clock">
            <div id="s_val"></div>
        </div>
    </div>
    ...
    <div class="cauhoi">
        ...
        <div class="dapan">
            <a class="option" href=""><button class="btn p1"><span>A:</span></button></a> 
            <a class="option" href=""><button class="btn p2"><span>B:</span><button></button></a> 
            <a class="option" href=""><button class="btn p3"><span>C:</span></button></a>
            <a class="option" href=""><button class="btn p4"><span>D:</span></button></a>
        </div>
        
    </div>
    <div class="icon">
        <a href=""><img src="img/AiLaTrieuPhu/menu.png" alt=""></a>
        <a href=""><img src="img/AiLaTrieuPhu/help1@3x.png" alt=""></a>
        <a href=""><img src="img/AiLaTrieuPhu/help2@3x.png" alt=""></a>
        <a href=""><img src="img/AiLaTrieuPhu/help3@3x.png" alt=""></a>
        <a href=""><img src="img/AiLaTrieuPhu/settings.png" alt=""></a>              
    </div>
    <!-- <div class="clock">
        <div id="s_val"></div>
    </div> -->
        ...
        $(document).ready(function() {
            ...
            $(".option").on("click", async function(e) {
                ...
                if (value == curQuestion.answer) {
                    await btn.addClass("true-answer");
                    await delay(1500);
                    ...
                    if (questionList.length == 0) {
                        ...
                        await updateScore()
                        await delay(1500);
                        window.location.replace(baseLaravelUrl + "/tienthuong")
                    }
                    curQuestion =  questionList[Math.floor(Math.random() * questionList.length)];
                    updateNewQuestion(curQuestion);   
